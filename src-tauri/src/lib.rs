...
mod tauri_app {
    ...
    use crate::commands::{
        ...
        terminal as terminal_commands, version_control, windows, work_task as work_task_commands,
    ...
    pub fn run() {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                acp_commands::acp_run_maintenance_command,
                ...
                acp_commands::acp_get_agent_config,
