...
vi.mock("@/lib/api", () => ({
  getAvailableTerminalShells: vi.fn(async () => ({ options: [] })),
  getSystemConversationOpenSettings: vi.fn(async () => ({
    defaultTarget: "tab",
    threshold: null,
  })),
  getSystemOpenTargetSettings: vi.fn(async () => ({
    target: "file_manager",
    web_file_open_method: "browser",
  })),
  ...
  updateSystemConversationOpenSettings: vi.fn(),
  updateSystemLanguageSettings: vi.fn(),
  updateSystemOpenTargetSettings: vi.fn(),
