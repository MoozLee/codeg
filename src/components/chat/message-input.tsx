      ...
      >
        ...
        >
          ...
          <Textarea
            ...
            className="min-h-0 flex-1 overflow-y-auto rounded-none border-0 bg-transparent pr-10 text-base shadow-none [field-sizing:fixed] focus-visible:border-0 focus-visible:ring-0 md:text-sm"
            autoFocus={autoFocus}
          />
